...
$insertar = "INSERT INTO venta(marca, modelo, id_nombre, nombre, stock, distribuidor, fecha, tipo, costo, descripcion) VALUES ('$marca','$modelo','$id_nombre','$nombre','$stock','$distribuidor','$fecha','$tipo','$costo','$descripcion')";
