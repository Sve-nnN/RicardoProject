...
<body>
    ...
    <form action="new-user-logic.php" method="post">
        ...
        <div class="contenedor-input">
            ...
            <input type="text" id="usuario" name="usuario" placeholder="Nombre de Usuario" class="Caja-1"
                title="Nombre de Usuario" tabindex="1" required>

            <input type="password" id="clave" name="clave" placeholder="Clave" class="Caja-1" title="Introducir Clave"
                tabindex="2" required>
            <input type="text" id="nombre" name="nombre" placeholder="Nombre y Apellido" class=" Caja-1"
                title="Introducir Nombre y apellido" tabindex="2" required>
            ...
            <input type="text" id="tipo" value="1" name="tipo" placeholder="tipo" class="Caja-1" title="Introducir tipo"
                tabindex="4" required>



            <input type="text" id="contrato" name="contrato" placeholder="Contrato" class="Caja-1"
                title="Introducir Numero de Contrato" tabindex="5" required>

            <input type="number" id="cedula" name="cedula" placeholder="Cedula" class="Caja-1" title="Numero de cedula"
                tabindex="6" required>
