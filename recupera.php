      ...
      <span>Datos de Ingreso no Validos, intentalo de nuevo por favor</span>
        ...
        <form action="Contra.php" method="post" >
            ...
            <div class="conten2">
               ...
               <br>
                <input type="text" name="usuario" placeholder="Administrador / Tecnico" autocomplete="off" pattern="[A-Za-z0-9_-]{4,15}">
                <br>
                <label style="color:#fff">Preguntas de Seguridad:</label>
                <br>
                <input type="text" name="contrato" placeholder="Numero de contrato" autocomplete="off" pattern="[A-Za-z0-9_-]{4,15}">
                <input type="text" name="cedula" placeholder="Numero de Cedula" autocomplete="off" pattern="[A-Za-z0-9_-]{4,15}">
                <br>
